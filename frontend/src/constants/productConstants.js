...
export const SOLDOUT_PRODUCTS_REQUEST = 'SOLDOUT_PRODUCTS_REQUEST'
export const SOLDOUT_PRODUCTS_SUCCESS = 'SOLDOUT_PRODUCTS_SUCCESS'
export const SOLDOUT_PRODUCTS_FAIL = 'SOLDOUT_PRODUCTS_FAIL'
